...
assert(entry.indexOf('applyOrdinaryLineagePlacement(spatialKnowledge)')<entry.indexOf('applyReasoningRadialPlacement(globalMainChain)'),'Reasoning projection must follow final ordinary Knowledge positions');
