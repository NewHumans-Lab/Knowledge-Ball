...
assert(CORE_SUN_LIGHT_INTENSITY>1,'core light must be strong enough to produce visible illumination');assert(CORE_AMBIENT_LIGHT_INTENSITY>0,'light-reactive nodes need a nonzero ambient floor');
