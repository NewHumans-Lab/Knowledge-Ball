...
export const STATUS_LABEL: Record<KnowledgeNodeStatus, string> = {
verified: '已验证',
pending: '等待验证',
suspended: '悬置',
disputed: '争议中',
...
export const MASTERY_LABEL: Record<KnowledgeMastery, string> = {
none: '未接触（无光点）',
touched: '接触过（荧光）',
mastered: '完全掌握（强光）',
};
...
export const STATUS_COLOR_HEX: Record<KnowledgeNodeStatus, string> = {
verified: '#5BA88B',
pending: '#7C93C9',
suspended: '#6B7290',
disputed: '#E0A030',
...
inner: { rMin: 0, rMax: 95 },
middle: { rMin: 95, rMax: 170 },
outer: { rMin: 170, rMax: 260 },
core: { rMin: 0, rMax: 16 },
} as const;
...
export const VIEW_PRESET_Z: Record<(typeof VIEW_ORDER)[number], number> = {
outer: 640,
middle: 420,
inner: 230,
core: 64,
...
export const SUN_REVEAL_CAM_Z = DEFAULT_CAM_Z / 10;
