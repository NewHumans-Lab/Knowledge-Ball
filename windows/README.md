...
Generated installers, executables, and screenshots live under ignored `windows/release/` and `windows/artifacts/`; they are intended for CI artifact publication instead of source control.
