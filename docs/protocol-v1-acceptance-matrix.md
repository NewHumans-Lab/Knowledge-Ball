...
| Theory merge | existing protocol tests | command/projection | two chains accepted; premise/rule/type checks | one event | replay covered | batch structure checks | Gap: downstream redirect and multi-chain matrix need dedicated tests |
